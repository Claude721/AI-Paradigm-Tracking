...
SECTIONS: list[tuple[str, list[tuple[str, str, str, str, bool]]]] = [
    ...
    (
        ...
        [
            ...
            ("SEMANTIC_SCHOLAR_API_KEY", "Semantic Scholar Key", "用于引用、作者和代表作增强；不填时限流更严格", "", False),
    ...
    (
        "范式筛选",
        [
            ("PARADIGM_MIN_SCORE", "报告最低总分", "0-100；默认 65", "65", False),
            ("PARADIGM_MIN_NOVELTY", "最低新颖性", "0-10；低于该值硬拒绝", "6", False),
            ("PARADIGM_MIN_SCOPE", "最低范式外延", "0-10；低于该值硬拒绝", "6", False),
            ("PARADIGM_MAX_DISCOVERY_ITEMS", "每期最大原始材料", "控制论文抽取成本", "100", False),
            ("PARADIGM_MAX_REPORT_ITEMS", "每期最多范式", "防止报告失焦", "12", False),
